...
const FirstStep = ({isDarkMode}) => {
  return (<div className="d-flex flex-row px-5">
    <div className={`d-flex flex-column py-5 mr-n5 text-center align-items-center justify-content-center`} style={{
      ...
      <small className="w-75">
        Your data is encrypted and stored only on your devices
      </small>

      <svg width="63px" height="60px" viewBox="0 0 99 96" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{
          marginLeft: "50px",
          marginTop: "40px"
        }}>
        <g transform="translate(-1169.000000, -893.000000)" fill={isDarkMode
            ? "#444"
            : "#A4A4A4"} fillRule="nonzero">
    ...
    <div style={{
      ...
      <img src="./second-step.png" alt="" height="400px" style={{
          objectFit: "contain"
        }}/>
    </div>
  </div>);
