...
type Props = Pick<
  NearLockAppType,
  'isSetupDone' | 'isDarkMode' | 'setIsSetupDone' | 'setIsModalOpen' | 'owner' | 'device'
>;
      ...
      <div className="flex justify-center">
        ...
        <div className="absolute top-[400px] flex w-3/5 flex-col items-center">
          ...
          <small className="text-center">
            To use Near Lock make sure your Mac has Bluetooth turned on and your iOS app is open on
            your iPhone
          </small>
