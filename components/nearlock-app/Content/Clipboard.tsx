...
import Keystroke from '@components/nearlock-app/Content/Keystroke';
import { Tab } from '@headlessui/react';
import { NearLockAppType } from '@interfaces/nearlock-app';
import classnames from 'classnames';

type Props = Pick<NearLockAppType, 'setActiveTab' | 'isDarkMode' | 'isSetupDone' | 'isSidebarOpen'>;

const Clipboard: React.FC<Props> = ({ isSetupDone, isDarkMode, setActiveTab, isSidebarOpen }) => (
  <Tab.Panel>
    {isSetupDone ? (
      <>
